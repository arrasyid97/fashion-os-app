...
    }
    ...
    // --- AWAL BLOK KEAMANAN BARU ---
    // 2. Verifikasi Token Webhook dari Mayar
    ...
    // --- AKHIR BLOK KEAMANAN BARU ---

    const { event, data } = request.body;
    
    // 3. Validasi Event Webhook (hanya proses pembayaran sukses)
...
    try {
        // 4. Menjalankan semua operasi database dalam satu transaksi yang aman
