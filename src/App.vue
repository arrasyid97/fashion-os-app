        ...
        <table class="w-full text-sm">
            <thead class="text-left text-slate-500">
                <tr>
                    ...
                    <th class="p-2 font-medium">HPP</th>
                    <th class="p-2 font-medium">HARGA JUAL</th>
                    <th class="p-2 font-medium text-right">AKSI</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-slate-200">
                <tr v-if="filteredModelProduk.length === 0">
                    <td colspan="9" class="p-4 text-center text-slate-500">Tidak ada model yang cocok.</td>
                </tr>
                <tr v-for="model in filteredModelProduk" :key="model.id">
                    ...
                    <td class="p-3 text-red-600">{{ formatCurrency(model.hpp || 0) }}</td>
                    <td class="p-3 text-green-600">{{ formatCurrency(model.hargaJual || 0) }}</td>
